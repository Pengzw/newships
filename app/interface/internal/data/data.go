...
import (
	...
	dpv1 "newships/api/department/v1"
	duv1 "newships/api/duty/v1"
	stv1 "newships/api/staff/v1"
	usv1 "newships/api/user/v1"
...
func NewUserServiceClient(r registry.Discovery) usv1.UserClient {
	conn, err := grpc.DialInsecure(
		context.Background(),
		grpc.WithEndpoint("discovery:///newships.user.grpc"),
...
func NewStaffServiceClient(r registry.Discovery) stv1.StaffClient {
	conn, err := grpc.DialInsecure(
		context.Background(),
		grpc.WithEndpoint("discovery:///newships.staff.grpc"),
		grpc.WithTimeout(time.Second*5),
		grpc.WithDiscovery(r),
	)
	if err != nil {
...
func NewDutyServiceClient(r registry.Discovery) duv1.DutyClient {
	conn, err := grpc.DialInsecure(
		context.Background(),
		grpc.WithEndpoint("discovery:///newships.duty.grpc"),
		grpc.WithTimeout(time.Second*5),
		grpc.WithDiscovery(r),
	)
	if err != nil {
...
func NewDeptServiceClient(r registry.Discovery) dpv1.DepartmentClient {
	conn, err := grpc.DialInsecure(
		context.Background(),
		grpc.WithEndpoint("discovery:///newships.department.grpc"),
		grpc.WithTimeout(time.Second*5),
		grpc.WithDiscovery(r),
	)
	if err != nil {
